app.directive('leftPanel', function($timeout) {
    return {
        restrict: "E",
        templateUrl: 'rest/app/admin/components/left-panel/left-panel.html',
        link: function($scope, $elem, $attr) {
            ...
            $scope.groups = [{
                    ...
                    items: [
                        ...
                        { name: 'System Monitoring', icon: 'fa fa-heartbeat', route: '' },
                ...
                },
                {
                    ...
                    items: [{ name: 'Private Cloud', icon: 'fa fa-cloud', route: 'home.unitedCloudPrivate' },
                ...
                },
                {
                    ...
                    items: [{ name: 'Service Requests', icon: 'fa fa-question-circle', route: 'home.serviceRequests' },
                ...
                },
                {
                    ...
                    items: [{ name: 'Tenant Management', icon: 'fa fa-user', route: 'home.tenantManagement' },
                        { name: 'Billing & Invoicing', icon: 'fa fa-credit-card', route: '' },
                        { name: 'Customer Integrations', icon: 'fa fa-exchange', route: 'home.customerIntegrations' },
                        ...
                        { name: 'AWS AMI', icon: 'fa fa-floppy-o', route: '' },
                        { name: 'Advanced', icon: 'fa fa-rocket', route: 'home.advanced' }
                    ],
                    open: false
                },
            ];
